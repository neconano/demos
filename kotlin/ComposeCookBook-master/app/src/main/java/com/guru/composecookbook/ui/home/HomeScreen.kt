...
private fun ChangeColorIconButton(
    ...
    // 获取系统服务，并将accessibilityManager 类型为 android.view.accessibility.AccessibilityManager
    val accessibilityManager = LocalContext.current.getSystemService(Context.ACCESSIBILITY_SERVICE)
            as android.view.accessibility.AccessibilityManager
    IconButton(onClick = {
        // 如果开启了辅助探索功能，则调试板弹出模式改成底部弹窗
...
fun PreviewHomeScreen() {
    ...
    // 设计预览被没有设置成上面appThemeState设置的颜色，查考 BaseView
    HomeScreen(appThemeState, chooseColorBottomModalState)
}
