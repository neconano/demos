...
class JSSDK {
  ...
  public function __construct($appId, $appSecret, $access_token = 'access_token.json', $jsapi_ticket = 'jsapi_ticket.json') {
    $this->appId = $appId;
  ...
  public function getSignPackage($p_url='') {//新加参数
    $jsapiTicket = $this->getJsApiTicket();
    $url = $p_url==""?"http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]":$p_url;
    $timestamp = time();
