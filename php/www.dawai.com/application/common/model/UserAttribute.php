 ...
 * 
 */
class UserAttribute extends Model3{
    /**
     * 数据库表名
     * 
     */
    ...
    protected $_validate = array(
        ...
        array('user_type', 'require', '未选择操作的用户类型', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
    );
    ...
    protected function checkTableExist($user_type){
        $table_name = C('DB_PREFIX').'user_'.D2('UserType')->getfieldById($user_type, 'name');
