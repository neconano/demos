...
;(function($){
	//标记更换方法
	var doutedChange = function(){
		$('.poster-main .poster-list .poster-item').each(function(){
			if($(this).hasClass('active')){
				$(this).parents('.container').eq(0).find('.douted-area i:eq('+$(this).index()+')').addClass('active').siblings().removeClass('active');
			}
		});
	};
	//定义PicCarousel类
